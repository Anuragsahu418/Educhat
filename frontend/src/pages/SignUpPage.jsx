...
import { Eye, EyeOff, Loader2, Lock, Mail, GraduationCap, User } from "lucide-react";
...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      return toast.error(
        "Password must be at least 6 characters long, with an uppercase letter, a lowercase letter, a number, and a special character."
      );
    }
    return true;
  };
